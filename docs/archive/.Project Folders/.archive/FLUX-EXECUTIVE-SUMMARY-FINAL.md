...
- Habitica: "Earned 15 XP" (meaningless virtual points)
- Flux: "Earned $35 this week" (real money transferred to savings)

**Two-sided earning system (unique differentiator):**

*BUILD Habits - Earn money for doing positive things:*
- Workout 30 minutes → Earn $1.50 (transferred from checking to Flux savings)
- Read 20 pages → Earn $1.00
- Meal prep → Earn $3.00

*RESIST Habits - Earn money for NOT doing negative things:*
- Don't order DoorDash today → Earn $35 (transferred from checking to Flux savings)
- Don't gamble today → Earn $50
- Don't buy unnecessary items → Earn $20

**Key psychological mechanism:**
Users are motivated by *opportunity cost* - "If I order DoorDash right now, I'll miss out on earning $35 today." This creates powerful motivation without penalties. You only earn money when you succeed, never lose money when you fail.
...
```
Monday-Thursday: User logs habits â†’ Balance accumulates (pending)
Friday 6am:      Automatic transfer checking â†’ Flux savings
...
**Success criteria:**
- âœ“ 8/10 family users still active after 4 weeks
- âœ“ 100% of transfers process successfully
...
**Target conversion:** 50% free â†’ paid  
...
â†’ Use Plaid (industry standard, 99.9% uptime)

**Transfer bugs lose user money:**  
â†’ Extensive testing, reserve fund, fast support

**Cannot scale infrastructure:**  
â†’ Use proven cloud services designed for scale

### Business Risks

**Users don't trust bank connections:**  
â†’ Use Plaid (trusted brand), clear security explanations

**Retention doesn't hit 60%:**  
â†’ Decision gates catch early, fix before scaling

**Cannot acquire users:**  
â†’ Organic growth first, prove product before paid acquisition

### Legal Risks

**Regulatory issues:**  
â†’ Legal consultation BEFORE launch, use Stripe Connect

**Data privacy violations:**  
â†’ GDPR/CCPA compliant from day one, encryption everywhere

### Market Risks

**Big tech copies us:**  
â†’ Move fast, build data moat, may lead to acquisition

**Market doesn't want real money:**  
â†’ Validate with family beta first, can pivot if needed
